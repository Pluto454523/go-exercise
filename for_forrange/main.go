...
func main() {
	...
	// กำหนด: 	1. 	ให้ใช้ for loop ทำการเปลี่ยนค่าในอาร์เรย์ genres โดยเพิ่มคำนำหน้า "Movie: " ทุกค่า
	// 				ดังนี้ "Movie: Action", "Movie: Adventure", "Movie: Fantasy"
